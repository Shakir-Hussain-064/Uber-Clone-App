...
router.post('/register', [
    ...
    body('vehicle.color').isLength({min: 3}).withMessage('Minimum length of 3 characters'),
    body('vehicle.plate').isLength({min: 6}).withMessage('Minimum length of 6 characters'),
